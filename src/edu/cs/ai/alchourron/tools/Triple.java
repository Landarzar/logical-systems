...
/***
 * A {@link HashMap} compatible Triple implementation, based on a Pair implementation by arturh. See the
...
public final class Triple<A, B, C> {
	...
	public boolean equals(Object other) {
		if (other instanceof Triple) {
			...
			return ((this.first == otherTriple.first || (this.first != null && otherTriple.first != null && this.first.equals(otherTriple.first)))
