...
//	public abstract SET complement(SET universe);
	...
	/***
	 * Constructs a new belief set which contains the contant of this set and the other belief set {@code o2}.
	 * @author Kai Sauerwald
	 * @param o2
	...
	/***
	 * Constructs a new belief set which contains only element which containted in this set and the other belief set {@code o2}.
	 * @author Kai Sauerwald
	...
	/***
	 * Constructs a new belief set which contains only element which containted in this set and not in the other belief set {@code o2}.
	 * @author Kai Sauerwald
	 * @param o2 The other belief set
